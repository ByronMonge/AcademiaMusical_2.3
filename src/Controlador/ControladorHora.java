...
public class ControladorHora {
    ...
    public ControladorHora(ModeloHorario modelo, VistaHorario vista) {
        this.modelo = modelo;
        this.vista = vista;
    ...
    public void abrirDialogCrear() {
        ...
        vista.getjDlgHorario().setSize(602, 592);
...
//                        if (vista.getComboHoraInicio().getItemAt(j).equalsIgnoreCase(h.getHor_horaIni())) {
